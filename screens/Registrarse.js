...
export default class Registrarse extends Component {
  ...
  render() {
    ...
    return(
      ...
      <Image source = {require('../assets/img/solicitud-linea-llamar-al-servicio-taxi-telefono-inteligente_1150-48845.png')}
              style={{
                width:'100%', height:200
              }}/>
      </View>
      <Text></Text>
              <Text style={styles.tittle}>Crea tu cuenta gratis</Text>
              <Text></Text>
              <Text style={styles.tittle2}>Ingresa la siguiente información para registrarte.
